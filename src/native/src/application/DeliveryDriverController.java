...
public class DeliveryDriverController implements Initializable {
	...
	public void toggleCheckBox(ActionEvent event) {
		...
		switch(id) {
		case "h1":
			if (c1.isSelected()) c1.setSelected(false);
			break;
		case "c1":
			if (h1.isSelected()) h1.setSelected(false);
			break;
		case "h2":
			if (c2.isSelected()) c2.setSelected(false);
			break;
		case "c2":
			if (h2.isSelected()) h2.setSelected(false);
			break;
		case "h3":
			if (c3.isSelected()) c3.setSelected(false);
			break;
		case "c3":
			if (h3.isSelected()) h3.setSelected(false);
			break;
		case "h4":
			if (c4.isSelected()) c4.setSelected(false);
			break;
		case "c4":
			if (h4.isSelected()) h4.setSelected(false);
			break;
		case "h5":
			if (c5.isSelected()) c5.setSelected(false);
			break;
		case "c5":
			if (h5.isSelected()) h5.setSelected(false);
			break;
		case "h6":
			if (c6.isSelected()) c6.setSelected(false);
			break;
		case "c6":
			if (h6.isSelected()) h6.setSelected(false);
			break;
		case "h7":
			if (c7.isSelected()) c7.setSelected(false);
			break;
		case "c7":
			if (h7.isSelected()) h7.setSelected(false);
			break;
		}
